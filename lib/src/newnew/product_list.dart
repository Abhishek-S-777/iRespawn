...
// import 'package:irespawn/src/newnew/product_page1.dart';
...
class ProductCardnew extends StatelessWidget {
  ...
  const ProductCardnew({Key key, this.product,this.height,this.width})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: ()
        {
          ////navigate to product details page after clicking on the product card....
