              ...
              children: [
                ListView(
                    children: userSnapshot.data.docs.map((userData) {
                      //This code block is for the users where they see
                      //only admins chat not all the other registered users

                      //This list to display is for the admin...
                      //he should be able to view all the users chats except his..
