...
class _HomeDrawerState extends State<HomeDrawer> {
              ...
              child: Column(
                ...
                children: <Widget>[
                          ...
                          child: Container(
                            ...
                            child: Material(
                              ...
                              child: Container(
                                ...
                                width: 160.0,
                                child: CircleAvatar(
                                  backgroundImage: NetworkImage(respawn.sharedPreferences.getString(respawn.userAvatarUrl),
                                )
                                ,
                              )
                            ),
                  ...
                  Padding(
                    ...
                    child: Text(
                      "Hello "+respawn.sharedPreferences.getString(respawn.userName),
                      style: TextStyle(
  ...
  Future<void> onTapped() async {
    await _authservice.signOut().then((result) {
      Fluttertoast.showToast(msg:'User Logged out successfully..',timeInSecForIos: 2);
